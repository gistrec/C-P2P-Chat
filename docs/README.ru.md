...
- Псевдографический интерфейс в стиле Midnight Commander, с цветами и временем сообщений.
- Имена пользователей до 12 символов.
- Сообщения до 60 символов, со счётчиком над полем ввода.
- Слэш-команды: `/help`, `/who`, `/clear`, `/quit`.
